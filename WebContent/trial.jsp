...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark">
  ...
  <ol class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="issue.jsp">Issued</a>
    </li>
    <li class="nav-item">
  ...
  <span>
      <li style="margin-left: 108vh;">
      <form action="login.jsp">
          <button style="background-color: black ; border-style: none; padding: 5px; margin-top: 3px; border-radius: 5px; height: 35px">
                			...
                			<font size="3" color="black">     
                            	...
                            	<!-- <button class="btn btn-outline-primary" type="button" onclick="var v=getval()">Check Products</button> -->
	                       		...
	                       		%>  
                       			 ...
                       			 Exisiting Quantity:
                       			 <br>
                       			 <input type="text" name="eqty" id="eqty" value="0" style="width:200px; height:5px;" readonly></input>
                       			 
                       			 <br><br>
                       			 
                       			 Quantity:
                       			 <br>
                       			 <input type="text" name="qty" id="qty" placeholder="0" style="width:200px; height:5px;"></input>
                       			 
                       			 <br><br>
                       			 
                       			 Price:
                       			 <br>
                       			 <input type="text" name="price" id="price" placeholder="Only while Adding" style="width:200px; height:5px;"></input>
