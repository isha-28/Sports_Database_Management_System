...
<br><br>
		...
		<%
		List<MatchDisplay> list=StockDisplaydao.getmatchresults();
		request.setAttribute("list",list);		
		%>
		<div id="aligntable">
		<table border="1" width="100%">
		
		<tr><th>SrNo</th><th>Matchdate</th><th>Category</th><th>Opponent</th><th>Tournament</th><th>Result</th></tr>
		<c:forEach items="${list}" var="u">
			<tr><td>${u.getSrno()}</td><td>${u.getMatch_date()}</td><td>${u.getCategory()}</td><td>${u.getOpponent()}</td><td>${u.getTournament()}</td><td>${u.getResult()}</td></tr>
...
<div class="row">
 ...
 <div class="col-lg-2">
 <form action="Report_matches.jsp">
