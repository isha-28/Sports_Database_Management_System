...
{
	var value=confirm("Are you sure you want to issue?");
	if(value==true)
		return true;
...
%>
				<div class="transbox">
                    <form  action="IssueServlet" onsubmit="return getConfirmation()">
                			 <center>  
                			<font size="5" color="black">ISSUE A PRODUCT</font>
                			</center>
                			<br>
                			<font size="3" color="black">  
                            	...
                            	<!-- <button class="btn btn-outline-primary" type="button" onclick="var v=getval()">Check Products</button> -->
                       			 ...
                       			 <br>
                       			 <select name="productList" id="stateList"  >
	                       			...
	                       			//rs1.next();
	                            	while(rs2.next()){ %>
							            <option><%= rs2.getString(2)+" - "+rs2.getString(3)%></option>
							        <% }
	                       			 %>    
                       			 </select>	
                       			 <br><br>
                       			  Student ID:
                       			  <br>
                     			 <input type="text" id="sid" name="sid" placeholder="Student id" style="width:200px; height:5px; required"></input>
                      			<br><br>
                       			 Quantity:
                       			 <br>
...
function getval()
{
	...
	window.location.replace("issue.jsp?sp_name="+sp_name);
