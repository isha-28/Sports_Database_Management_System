...
<br><br><br>
 ...
 <form action="issueret.jsp">
  <button class="button3">
		...
		<br><br><br>
		<%
		List<ReturnDisp> list=StockDisplaydao.displayreturn();
		request.setAttribute("list",list);		
		%>
		<div id="aligntable">
		<table border="1" width="100%">
		
		<tr><th>Student ID</th><th>Student Name</th><th>Sport Name</th><th>Product Name</th><th>Quantity</th><th>Issue-date</th><th>Return-date</th><th>Fine</th></tr>
		<c:forEach items="${list}" var="u">
			<tr><td>${u.getStudentid()}</td><td>${u.getStudentname()}</td><td>${u.getSportname()}</td><td>${u.getProductname()}</td><td>${u.getQuantity()}</td><td>${u.getIssuestring()}</td><td>${u.getReturnstring()}</td><td>Rs.${u.getFine()}/-</td></tr>		
		</c:forEach>
