 ...
 <form action="processPassword.jsp" method="post">
	  <br>
				<i class="fa fa-lock icon" style="size:50px">
             	 <input type="password" id="npass" class="fadeIn  third" name="npass" placeholder="New Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" autocomplete="off" required>
             	 </i>
			<br>
			      <i class="fa fa-lock icon" style="size:50px">
             	 <input type="password" id="npassconf" class="fadeIn  third" name="npassconf" placeholder="Confirm Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" autocomplete="off" required>
             	 </i>
